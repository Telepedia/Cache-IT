/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 760850951237d7c525be32c7bfba7df7)
// Runtime types generated with workerd@1.20250410.0 2025-04-16 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		NO_CACHE_COOKIES: ["telepedia_session","wgToken","wgSession","wgUser","betacentralauth_Session","betacentralauth_User","betacentralauth_ss0-User","centralauth_Session","centralauth_User","ss0-betacentralauth_Session"];
		PAGE_TTL: 86400;
		MISSING_TTL: 3600;
		NAMESPACES_INELIGIBLE_FOR_CACHE: ["MediaWiki","Special","Module"];
		IMAGE_TTL: 604800;
		NO_CACHE_DOMAINS: ["auth.telepedia.net"];
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NO_CACHE_COOKIES" | "PAGE_TTL" | "MISSING_TTL" | "NAMESPACES_INELIGIBLE_FOR_CACHE" | "IMAGE_TTL" | "NO_CACHE_DOMAINS">> {}
}
